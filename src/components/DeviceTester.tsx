...
const DeviceTester = ({
  ...
  return (
    <div className="w-full max-w-4xl mx-auto flex flex-col items-center px-4">
      {/* Header Section */}
      <div className="mb-8 custom-float text-center">
      ...
      <div className="grid md:grid-cols-2 gap-6 w-full mb-8">
        ...
        <div className={`
          ...
          flex flex-col min-h-[280px] bg-white
          ${isMicReady 
        ...
        `}>
          ...
          <div className="flex items-start gap-4 mb-4">
            <img 
              ...
              alt="Microphone"
              className="w-14 h-16 shrink-0 object-contain"
            />
            <div className="flex-1">
              <h3 className="text-lg font-bold text-gray-900 mb-1">Test mic</h3>
        ...
        `}>
          ...
          <div className="flex items-start gap-4 mb-4">
            ...
            />
            <div className="flex-1">
              <h3 className="text-lg font-bold text-gray-900 mb-1">Test speaker</h3>
              <p className="text-xs text-slate-500 font-medium">
                {isSpeakerReady 
                  ? "Ready to play audio" 
      ...
      <div className="text-center w-full max-w-md">
        <Button
          ...
          className={`
            w-full py-6 px-8 rounded-2xl font-bold text-base shadow-lg
            transition-all duration-300
            ${isReadyToStart
              ? "bg-[#2B5E2B] hover:bg-[#1a3a1b] text-white hover:scale-[1.02] hover:shadow-xl"
