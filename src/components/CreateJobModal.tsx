    ...
    return (
        <Dialog open={isOpen} onOpenChange={(open) => !open && handleClose()}>
            <DialogContent className="sm:max-w-[720px] max-h-[92vh] overflow-hidden p-0 gap-0 rounded-3xl border border-gray-200 shadow-2xl bg-[#fcfdfc]"
                ...
                {/* Scrollable Body */}
                <div className="overflow-y-auto max-h-[calc(92vh-160px)] px-8 py-6 custom-scrollbar bg-white">
                    <form id="job-form" onSubmit={handleSubmit} className="space-y-6">
                        
                        {/* Job Title with Dropdown Fix */}
                        <div className="space-y-2">
                            ...
                            {errors.jobTitle && <p className="text-xs font-bold text-red-500 ml-1">{errors.jobTitle}</p>}
                        </div>
                        ...
                        {/* Skills Sections with Internal Scrollbar Fix */}
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div className="space-y-2">
                                ...
                                />
                                {errors.technicalSkills && <p className="text-xs font-bold text-red-500 ml-1">{errors.technicalSkills}</p>}
                            </div>
                            ...
                            <div className="space-y-2">
                                ...
                                />
                                {errors.soft_skills && <p className="text-xs font-bold text-red-500 ml-1">{errors.soft_skills}</p>}
                            </div>
                        </div>
                    </form>
                </div>
                ...
                <style>{`
                    ...
                    button[aria-label="Close"] { display: none; }
                    /* Ensuring tag-input suggestions also use custom scroll */
                    .tag-input-suggestions-list { max-height: 200px; overflow-y: auto; }
                `}</style>
            </DialogContent>
        </Dialog>
    );
