...
export default function SelfApply() {
  ...
  return (
    <div className="h-screen bg-white flex flex-col font-sans overflow-hidden">
      ...
      {/* --- MAIN CONTENT AREA --- */}
      <main className="flex-1 flex flex-col px-12 py-4 overflow-hidden relative">
        
        {/* Transparent Back Button (Inside Main, No Header Styling) */}
        <div className="mb-2">
          <button 
        ...
        <div className="flex-1 flex flex-col items-center justify-center">
          {step === "job_selection" ? (
            <div className="w-full max-w-6xl flex flex-col items-center">
              ...
              {/* Zoe Avatar */}
              <div className="mb-6 custom-float">
              ...
              {loadingJobs ? (
                ...
                <div className="w-full space-y-12">
                  ...
                  {/* Custom Role CTA */}
                  <div className="text-center space-y-6 opacity-0 custom-fade-in" style={{ animationDelay: '600ms', animationFillMode: 'forwards' }}>
                    <h3 className="text-lg font-bold text-gray-800 tracking-tight">Can't find a job role to practice?</h3>
                    <Button
                      onClick={() => setIsCreateJobModalOpen(true)}
                      className="bg-[#2C5F2D] hover:bg-[#1a3a1b] text-white font-black px-12 py-7 h-auto rounded-2xl shadow-xl transition-all hover:scale-105"
                    >
                      <Plus className="mr-3 w-6 h-6" /> Create Custom Interview
                    </Button>
                    <div className="flex justify-center">
                      <Badge className="px-6 py-2 font-black text-[#007AFF] rounded-lg bg-[#EBF5FF] border border-[#D1E9FF] text-[10px] uppercase tracking-widest">
            ...
            /* System Check UI */
            <div className="w-full max-w-3xl custom-zoom-in">
               <div className="bg-white rounded-[2.5rem] border border-gray-100 shadow-2xl overflow-hidden">
                  <div className="bg-[#1A1A1A] p-10 text-white flex items-center justify-between">
                    ...
                    <Sparkles size={24} className="text-green-400 opacity-20" />
                  </div>
                  <div className="p-10">
                    <DeviceTester onStartInterview={handleStartInterview} />
                  </div>
